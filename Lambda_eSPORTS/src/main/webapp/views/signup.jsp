...
<body>
	...
	<div class="reg-container">
		<div class="reg-box">
			<h2>Registrati!</h2>
			<form:form id="reg-form" action="/players/signup"
				modelAttribute="playerForm" method="post">
				<div class="input-group">
					<label for="email">Email</label>
					<form:input path="email" type="email" id="email"
						placeholder="Inserisci la tua email" required="true" />
				</div>
				<div class="input-group">
					<label for="name">Nome</label>
					<form:input path="firstName" type="text" id="name"
						placeholder="Inserisci il tuo nome" required="true" />
				</div>
				<div class="input-group">
					<label for="surname">Cognome</label>
					<form:input path="lastName" type="text" id="surname"
						placeholder="Inserisci il tuo cognome" required="true" />
				</div>
				<div class="input-group">
					<label for="username">Username</label>
					<form:input path="username" type="text" id="username"
						placeholder="Inserisci il tuo username" required="true" />
				</div>
				<div class="input-group">
				...
				<div class="input-group">
					...
					<div class="password-container">
						<form:input path="password" type="password" id="password"
							placeholder="Inserisci la tua password" required="true" />
						<span class="toggle-password"
							onclick="togglePassword('password', 'eye-icon1')"> <img
							id="eye-icon1"
				...
				<div class="input-group">
					...
					<div class="password-container">
						<input type="password" id="confirm-password"
							placeholder="Conferma la tua password" required> <span
					...
					<small id="password-error" style="color: red; display: none;">⚠️
						Le password non coincidono!</small>
				</div>

				<button type="submit" id="register-btn" disabled>Registra
					Account</button>
			</form:form>
		</div>
	</div>
