...
<body>
	...
	<table class="lista-partecipazioni">
		...
		<tbody>
			<tr>
				<td>Crossbar challenge</td>
				<td>FC25</td>
				<td>25/05/25</td>
				<td>0.83</td>
				<td><button class="edit">Visualizza</button>
					<button class="delete">Abbandona</button></td>
			</tr>
			<tr>
				<td>360 NO SCOPE</td>
				<td>COD WARZONE</td>
	...
	<div id="popup-conferma" class="popup">
		<p>Vuoi davvero abbandonare il torneo?</p>
